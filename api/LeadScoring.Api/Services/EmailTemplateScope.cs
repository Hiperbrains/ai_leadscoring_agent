...
public static class EmailTemplateScope
{
    public static IQueryable<EmailTemplate> ApplyLeadScope(IQueryable<EmailTemplate> query, Lead lead)
    {
        ...
        {
            query = query.Where(t => t.CompanyName == companyName || t.CompanyName == null);
        }
    ...
    public static IQueryable<EmailTemplate> OrderForLead(IQueryable<EmailTemplate> query, Lead lead)
    {
        var companyName = lead.CompanyName?.Trim();
        return query
            .OrderByDescending(t => companyName != null && t.CompanyName == companyName)
        ...
        int? productId)
    {
        ...
        {
            query = query.Where(t => t.CompanyName == normalizedCompany || t.CompanyName == null);
        }
        ...
        int? productId)
    {
        var normalizedCompany = companyName?.Trim();
        return query
            .OrderByDescending(t => normalizedCompany != null && t.CompanyName == normalizedCompany)
